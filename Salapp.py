...
model = pickle.load(open(r'C:\Users\SUNITHA\A VS CODE\PYTHONDEVELOPERCODE\STATISTICS\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience. Built model by Sunitha Mekala")